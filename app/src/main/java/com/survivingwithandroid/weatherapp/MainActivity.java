...
public class MainActivity extends FragmentActivity {
	...
	String arr[] = {"Dhaka", "Chittagong", "Sylhet", "Khulna", "Rajshahi", "Barisal", "Rangpur", "Feni"};
	String city;
	String lang = "en";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		city = "Dhaka";
		spinnerCities.setAdapter(new ArrayAdapter<String>(MainActivity.this, R.layout.spinner_item_layout,
				arr));
		spinnerCities.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			@Override
			public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
				 city = spinnerCities.getItemAtPosition(position).toString();
